# 作业管理系统（Redrock Assessment System）

## 项目简介

本项目是一个面向部门使用的作业管理系统，支持管理员/讲师发布与批改作业、学员提交作业并查看评语的完整流程。系统按部门划分权限，涵盖后端、前端、SRE、产品、视觉设计、Android、iOS七个方向，并集成了 AI 初评功能以辅助教学评估。
